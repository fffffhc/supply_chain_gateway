...
import com.scf.erdos.client.dao.SysClientDao;
import com.scf.erdos.client.dao.SysServiceDao;
...
/**
 * @Description : 应用可访问API列表控制
 *                通过认证信息获取clientId ，通过 clientId 判断是否有clientInfo;
 *                通过 clientId 获取对应的serviceInfo ;
 *                比对应用访问URI 是否该clientId 对应的service URI。
 * @author：bao-clm
 * @date: 2019/1/12
 * @version：1.0
 */
