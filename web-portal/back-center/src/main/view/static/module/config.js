layui.define(function (exports) {
    ...
    var config = {
        base_server: 'http://192.168.1.8:9200/', // 接口地址，实际项目请换成http形式的地址 http://106.13.3.200:80/	http://127.0.0.1:9200/
        eureka_server: 'http://192.168.1.8:9200/', // eureka注册中心地址				http://106.13.3.200:80/	http://127.0.0.1:9200/
