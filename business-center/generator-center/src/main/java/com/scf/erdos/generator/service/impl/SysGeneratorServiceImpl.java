package com.scf.erdos.generator.service.impl;
...
import com.scf.erdos.generator.dao.SysGeneratorDao;
import com.scf.erdos.generator.service.SysGeneratorService;
import com.scf.erdos.generator.utils.GenUtils;
...
public class SysGeneratorServiceImpl implements SysGeneratorService {
    ...
    public PageResult queryList(Map<String, Object> map) {
        ...
        return PageResult.builder().data(pageInfo.getList()).page(0).limit(11).count(pageInfo.getTotal()).build();
    }
