package com.scf.erdos.sms.service.impl;

import java.util.Date;
import java.util.List;
import java.util.Map;

import com.scf.erdos.sms.dao.SmsDao;
import com.scf.erdos.sms.model.Sms;
import com.scf.erdos.sms.service.SmsService;
...
//		测试时不需要开此 add by someday end
	...
	public PageResult<Sms> findSms(Map<String, Object> params) {
		...
		return PageResult.<Sms>builder().data(pageInfo.getList()).page(0).limit(10).count(pageInfo.getTotal()).build();
	}
