...
public interface SysRoleService {
	 ...
	 * @return
	 */
	Result findRoles(Map<String, Object> params)  throws ServiceException;
	...
	Result saveOrUpdateV1_1(SysRole sysRole) throws ServiceException;

	Result getRoleInfo(SysRole sysRole) throws ServiceException;
